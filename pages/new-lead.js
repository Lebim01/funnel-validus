      ...
      <div className="w-full max-w-xs">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" autoComplete='off' onSubmit={register}>
          ...
          <div className="mb-4">
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" name="description" type="text" placeholder="Descripcion" autoComplete='off' required />
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="video" name="video" type="text" placeholder="Opcional" autoComplete='off' />
          </div>
          <div className="mb-6">
